...
"}"));
        ...
        sizePolicy1.setHeightForWidth(moodBox->sizePolicy().hasHeightForWidth());
        moodBox->setSizePolicy(sizePolicy1);
        moodBox->setMinimumSize(QSize(21, 30));
        moodBox->setStyleSheet(QStringLiteral(""));

        gridLayout->addWidget(moodBox, 3, 10, 1, 1);

        moodLabel = new QLabel(centralWidget);
        moodLabel->setObjectName(QStringLiteral("moodLabel"));
        QFont font1;
        font1.setPointSize(16);
        font1.setBold(true);
        font1.setWeight(75);
        moodLabel->setFont(font1);
        moodLabel->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(moodLabel, 12, 10, 1, 1);
        ...
        sizePolicy2.setHeightForWidth(songLabel->sizePolicy().hasHeightForWidth());
        songLabel->setSizePolicy(sizePolicy2);
        songLabel->setBaseSize(QSize(500, 600));
        songLabel->setFont(font1);
        songLabel->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(songLabel, 0, 4, 1, 5);

        newUserButton = new QPushButton(centralWidget);
        newUserButton->setObjectName(QStringLiteral("newUserButton"));
        newUserButton->setMinimumSize(QSize(74, 30));

        gridLayout->addWidget(newUserButton, 5, 10, 1, 1);
        ...
        sizePolicy3.setHeightForWidth(songList->sizePolicy().hasHeightForWidth());
        songList->setSizePolicy(sizePolicy3);
        ...
        gridLayout->addWidget(songList, 1, 4, 22, 5);
...
"}"));
        ...
        gridLayout->addWidget(timeSlider, 24, 4, 1, 5);
        ...
        gridLayout->addWidget(volumeLabel, 23, 10, 1, 1);
        ...
        gridLayout->addWidget(playPauseButton, 24, 0, 1, 1);

        horizontalSpacer_2 = new QSpacerItem(5, 5, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_2, 24, 1, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(playlistLabel->sizePolicy().hasHeightForWidth());
        playlistLabel->setSizePolicy(sizePolicy4);
        playlistLabel->setMaximumSize(QSize(16777215, 20));
        playlistLabel->setFont(font1);
        playlistLabel->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(playlistLabel, 0, 0, 1, 3);

        loadButton = new QPushButton(centralWidget);
        loadButton->setObjectName(QStringLiteral("loadButton"));
        loadButton->setMinimumSize(QSize(74, 30));

        gridLayout->addWidget(loadButton, 1, 10, 1, 1);
        ...
        gridLayout->addWidget(skipButton, 24, 2, 1, 1);

        horizontalSpacer_4 = new QSpacerItem(5, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_4, 23, 9, 1, 1);

        horizontalSpacer = new QSpacerItem(5, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer, 24, 3, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(volumeSlider, 24, 10, 1, 1);

        trackDataLabel = new QLabel(centralWidget);
        trackDataLabel->setObjectName(QStringLiteral("trackDataLabel"));
        sizePolicy2.setHeightForWidth(trackDataLabel->sizePolicy().hasHeightForWidth());
        trackDataLabel->setSizePolicy(sizePolicy2);
        trackDataLabel->setMaximumSize(QSize(550, 20));
        QFont font4;
        font4.setPointSize(12);
        trackDataLabel->setFont(font4);
        trackDataLabel->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(trackDataLabel, 23, 3, 1, 6);
        ...
        gridLayout->addWidget(timeLabel, 23, 0, 1, 3);
        ...
        gridLayout->addWidget(playList, 1, 0, 22, 4);

        verticalSpacer_2 = new QSpacerItem(20, 5, QSizePolicy::Minimum, QSizePolicy::Fixed);

        gridLayout->addItem(verticalSpacer_2, 4, 10, 1, 1);

        wakefulnessLabel = new QLabel(centralWidget);
        wakefulnessLabel->setObjectName(QStringLiteral("wakefulnessLabel"));
        wakefulnessLabel->setFont(font1);
        wakefulnessLabel->setAlignment(Qt::AlignCenter);

        gridLayout->addWidget(wakefulnessLabel, 13, 10, 1, 1);
        ...
        gridLayout->addWidget(label, 11, 10, 1, 1);
    ...
    void retranslateUi(QMainWindow *musicPlayer)
    {
        ...
        moodLabel->setText(QApplication::translate("musicPlayer", "No Input", 0));
        songLabel->setText(QApplication::translate("musicPlayer", "Songs", 0));
        newUserButton->setText(QApplication::translate("musicPlayer", "New User #0", 0));
        ...
        wakefulnessLabel->setText(QApplication::translate("musicPlayer", "No Input", 0));
        label->setText(QApplication::translate("musicPlayer", "Mental State", 0));
    } // retranslateUi
